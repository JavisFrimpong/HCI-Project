...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-20 bg-white shadow-md transition-all duration-300 ${scrolled ? 'py-2' : 'py-3'}`}>
      <div className="w-full flex justify-between items-center px-4 md:px-6 lg:px-8">
        {/* Logo + Info */}
